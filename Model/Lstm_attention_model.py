...
def Lstm_attention_model(train_path, test_path, iter, epochs, batch_size, flag):
    ...
    for i in range(iter):
        ...
        # out_x = layers.LSTM(100)(x_2)     # (None, 100)
...
# Lstm_attention_model('../DataSet_all_cross_talk/DataSet4-200/Str_set/train1.txt', '../DataSet_all_cross_talk/DataSet4-200/Str_set/test0.txt', 5, 30, 128, False)
