...
def Cnn_Lstm_model(train_path, test_path, iter, epochs, batch_size, flag):
...
# Cnn_Lstm_model('../DataSet_all_cross_talk/DataSet/Str_set/train10.txt', '../DataSet_all_cross_talk/DataSet/Str_set/test1.txt', 10, 30, 64, False)