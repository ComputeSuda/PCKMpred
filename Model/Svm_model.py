...
def Svm_model(train_path, test_path, flag):  # flag:True(seq), False(str)
    ...
    if not flag:
        ...
        # egsmote = EGSmote(sampling_rate=1/3)
    ...
    score_pre = cross_val_score(clf, train_data, train_label, cv=10).mean()  # cv:折数
    # print(score_pre)
    pred_prob = clf.predict_proba(test_data)[:, 1]  # (1167,)
...
# for i in range(5):
#     print('i:', i)
#     Svm_model('../DataSet_all_cross_talk/DataSet4-200/Str_set/train39.txt', '../DataSet_all_cross_talk/DataSet4-200/Str_set/test'+str(i)+'.txt', False)
