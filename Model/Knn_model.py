...
def Knn_model(train_path, test_path, flag):  # flag:True(seq), False(str)
...
# for i in range(5):
#     print('i:', i)
#     Knn_model('../DataSet_all_cross_talk/DataSet4-200/Str_set/train39.txt', '../DataSet_all_cross_talk/DataSet4-200/Str_set/test'+str(i)+'.txt', False)
