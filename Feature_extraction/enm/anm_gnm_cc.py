...
rcsb_pdb_path = '../../Dataprocess/PDB/RCSB'
rcsb_pdb_file_name_list = os.listdir(rcsb_pdb_path)
pdb_file_name_list = rcsb_pdb_file_name_list
...
print(len(rcsb_pdb_name_list))
rcsb_pdb_chain = dict()
alphafold_pdb_chain = dict()

rcsb_df = open('./all_pdb.txt', 'r')
